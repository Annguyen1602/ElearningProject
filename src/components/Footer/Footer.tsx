...
export default function Footer({}: Props) {
  return (
    <div className="footer bg-dark p-4">
      <div className="row">
        <div className="leftComponent col-10 col-md-5 col-lg-4 mb-md-5 mb-5">
          <div className="logo">
        ...
        <div className="centerComponent col-10 col-md-5 col-lg-4 mb-5">
          ...
          <div>
            ...
            <button className="btn">ĐĂNG KÝ TƯ VẤN</button>
          </div>
        ...
        <div className="rightComponent col-10 col-md-5 col-lg-4">
          <iframe
            src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Flophocviet&tabs=timeline&width=340&height=331&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
            width={400}
            height={331}
          ...
          />
          <div className="link">
            <a href="#">Anh ngữ giao tiếp</a>
            <a href="#"> Khởi động anh ngữ giao tiếp</a>
            <a href="#"> Lấy đà anh ngữ giao tiếp</a>
            <a href="#"> Bật nhảy anh ngữ giao tiếp</a>
            <a href="#">Bay trên không Anh ngữ giao tiếp</a>
            <a href="#">Tiếp đất</a>
          </div>
        </div>
      </div>
